...
class IntegralGui(CTkFrame):
    def __init__(self, master):
        ...
        self.parent = master
        self.parent.geometry("{}x{}".format(800, 460))
        ...
        self.end_limit = None
        self.formula = None
        self.last_logs_results = IntegralGui.read_formula_file(self)
    ...
    def read_formula_file(self):
        f = open("logs/integral_logs.txt", "r")
        whole_file = []
        for line in f:
    ...
    def add_log_to_file(self, formula, result):
        f = open("logs/integral_logs.txt", "a")
